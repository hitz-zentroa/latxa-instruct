...
#SBATCH --job-name=exp_1_111_fixed
#SBATCH --cpus-per-task=16
#SBATCH --nodes=32
#SBATCH --ntasks-per-node=1
#SBATCH --gres=gpu:4
#SBATCH --output=.slurm/exp_1_111_fixed.out
#SBATCH --error=.slurm/exp_1_111_fixed.err
#SBATCH --mem=168GB
#SBATCH --exclude=lrdn0310,lrdn0323,lrdn0332,lrdn0340,lrdn0317,lrdn2031,lrdn1480
...
srun accelerate launch \
    ...
    -m axolotl.cli.train ~/latxa-instruct/model_training/train_configs//exp_1_111_fixed.yaml
