...
#SBATCH --job-name=exp_0_101_fixed
#SBATCH --cpus-per-task=16
#SBATCH --nodes=32
#SBATCH --ntasks-per-node=1
#SBATCH --gres=gpu:4
#SBATCH --output=.slurm/exp_0_101_fixed.out
#SBATCH --error=.slurm/exp_0_101_fixed.err
#SBATCH --mem=168GB
...
srun accelerate launch \
    ...
    -m axolotl.cli.train ~/latxa-instruct/model_training/train_configs//exp_0_101_fixed.yaml
