...
#SBATCH --job-name=exp_1_010_fixed
#SBATCH --cpus-per-task=16
#SBATCH --nodes=32
#SBATCH --ntasks-per-node=1
#SBATCH --gres=gpu:4
#SBATCH --output=.slurm/exp_1_010_fixed.out
#SBATCH --error=.slurm/exp_1_010_fixed.err
#SBATCH --mem=168GB
...
srun accelerate launch \
    ...
    -m axolotl.cli.train ~/latxa-instruct/model_training/train_configs//exp_1_010_fixed.yaml
